...
- [Sample Snippet (TQ-DSL in Use)](#sample-snippet-tq-dsl-in-use)
- [AI Features Enabled by TQ-DSL](#ai-features-enabled-by-tq-dsl)
- [For Developers: Parsing TQ-DSL for AI Systems](#for-developers-parsing-tq-dsl-for-ai-systems)
- [Open Source & Community Principles](#open-source--community-principles)
- [Future Extensions (v10)](#future-extensions-v10)
